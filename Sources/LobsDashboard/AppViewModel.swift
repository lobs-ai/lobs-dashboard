...
final class AppViewModel: ObservableObject {
  ...
  /// The commit hash that this binary was built from (set at build time via BuildInfo.generated.swift).
  /// Falls back to empty string if the generated file doesn't exist yet.
  private var builtFromCommit: String {
    // BuildInfo.builtCommit is generated by the pre-build script.
    // If it's empty or "unknown", we can't compare.
