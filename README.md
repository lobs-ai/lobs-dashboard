...
- 🤖 **AI Task Execution** — Request worker assistance for automated task completion
...
Click the **Request Worker** button to create a priority work request. The orchestrator will spawn a worker within the next polling cycle (~2 minutes).
